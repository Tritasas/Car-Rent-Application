...
! function (e) {
    ...
    "use strict";
    var A, i, e, l, d = o.fn.dataTable;

    function r(t, s) {
        var e = this;
        if (i && i.versionCheck && i.versionCheck("1.10.0")) return t = new i.Api(t), this.classes = A.extend(!0, {}, r.classes), this.c = A.extend(!0, {}, r.defaults, s), s && s.left !== F || this.c.leftColumns === F || (this.c.left = this.c.leftColumns), s && s.right !== F || this.c.rightColumns === F || (this.c.right = this.c.rightColumns), this.s = {
            barWidth: 0,
            dt: t,
    ...
    function h(t, s) {
        void 0 === s && (s = null);
        t = new d.Api(t), s = s || t.init().fixedColumns || d.defaults.fixedColumns;
        new e(t, s)
    }
    return r.prototype.left = function (t) {
        ...
        for (var t = null, s = this.s.dt.column(0).header(), e = null, i = (null !== s && (e = (s = A(s)).outerHeight() + 1, t = A(s.closest("div.dataTables_scroll")).css("position", "relative")), this.s.dt.column(0).footer()), o = null, l = (null !== i && (o = (i = A(i)).outerHeight(), null === t) && (t = A(i.closest("div.dataTables_scroll")).css("position", "relative")), this.s.dt.columns().data().toArray().length), d = 0, r = 0, h = A(this.s.dt.table().node()).children("tbody").children("tr"), n = 0, a = new Map, c = 0; c < l; c++) {
            ...
            if (0 < c && a.set(c - 1, n), f.visible()) {
                ...
                if (c - n < this.c.left) {
                    if (A(this.s.dt.table().node()).addClass(this.classes.tableFixedLeft), t.addClass(this.classes.tableFixedLeft), 0 < c - n)
                        for (var g = c; g + 1 < l;) {
                            if ((S = this.s.dt.column(g - 1, {
                                ...
                                d += A(S.nodes()[0]).outerWidth(), r += S.header() || S.footer() ? A(S.header()).outerWidth() : 0;
                                break
                            }
                            g--
                        }
                    ...
                    u.css(this._getCellCSS(!0, r, "left")).addClass(this.classes.fixedLeft), m.css(this._getCellCSS(!0, r, "left")).addClass(this.classes.fixedLeft)
                } else {
                    ...
                    u.hasClass(this.classes.fixedLeft) && u.css(this._clearCellCSS("left")).removeClass(this.classes.fixedLeft), m.hasClass(this.classes.fixedLeft) && m.css(this._clearCellCSS("left")).removeClass(this.classes.fixedLeft)
                }
            } else n++
        }
        for (var B = 0, k = 0, y = 0, c = l - 1; 0 <= c; c--)
            if ((f = this.s.dt.column(c)).visible()) {
                ...
                if (_ === F && (_ = n), c + y >= l - this.c.right) {
                    if (A(this.s.dt.table().node()).addClass(this.classes.tableFixedRight), t.addClass(this.classes.tableFixedRight), c + 1 + y < l)
                        for (var S, g = c; g + 1 < l;) {
                            if ((S = this.s.dt.column(g + 1, {
                                ...
                                B += A(S.nodes()[0]).outerWidth(), k += S.header() || S.footer() ? A(S.header()).outerWidth() : 0;
                                break
                            }
                            g++
                        }
                    ...
                    u.css(this._getCellCSS(!0, k, "right")).addClass(this.classes.fixedRight), m.css(this._getCellCSS(!0, k, "right")).addClass(this.classes.fixedRight)
                } else {
                    ...
                    u.hasClass(this.classes.fixedRight) && u.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight), m.hasClass(this.classes.fixedRight) && m.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight)
                }
            } else y++;
        ...
        this.s.dt.off(".dtfc"), this.dom.leftBottomBlocker.remove(), this.dom.leftTopBlocker.remove(), this.dom.rightBottomBlocker.remove(), this.dom.rightTopBlocker.remove()
        ...
        this.s.dt.on("key-focus.dt.dtfc", function (t, s, e) {
            var i, o, l, d = A(e.node()).offset(),
                r = A(A(h.s.dt.table().node()).closest("div.dataTables_scrollBody"));
            0 < h.c.left && (i = (o = A(h.s.dt.column(h.c.left - 1).header())).offset(), o = o.outerWidth(), d.left < i.left + o) && (l = r.scrollLeft(), r.scrollLeft(l - (i.left + o - d.left))), 0 < h.c.right && (i = h.s.dt.columns().data().toArray().length, o = A(e.node()).outerWidth(), e = A(h.s.dt.column(i - h.c.right).header()).offset(), d.left + o > e.left) && (l = r.scrollLeft(), r.scrollLeft(l - (e.left - (d.left + o))))
        ...
        init: function (t, s, e) {
            t.settings()[0]._fixedColumns === F && h(t.settings(), e), o(s).attr("active", "true").addClass("active"), t.button(s).text(e.text || t.i18n("buttons.fixedColumns", t.settings()[0]._fixedColumns.c.i18n.button))
        },
        text: null
